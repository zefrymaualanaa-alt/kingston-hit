...
bot.start(async (ctx) => {
    ...
    const welcomeText = `<b>[ KINGSTON AUTOMATION SYSTEM ]</b>\n\n` +
        `Selamat datang di sistem otomatisasi KINGSTON. Bot ini berfungsi sebagai mesin extractor otomatis untuk mendapatkan cookies Netflix (Live) secara massal.\n\n` +
